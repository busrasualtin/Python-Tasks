...
# 📌 Use the .plot() function of Matplotlib to create a line plot.
...
# 📌 Use the .scatter() function of Matplotlib to create a scatter plot.
...
# 📌 Use the .bar() function of Matplotlib to create a bar chart.
